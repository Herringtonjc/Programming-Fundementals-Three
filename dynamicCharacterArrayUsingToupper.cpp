...
#include <iomanip>
#include <fstream>
#include <ctype.h> //This is needed for the toupper function
using namespace std;
...
int main()
{
    ...
    for(int i = 0; i < arraySize; i++)
    {
        ...
        outfile << a[i] << " "; //Output all array values ***Lines 29-30 are redundant, as the output could be done from arrayString[i]***
    }
